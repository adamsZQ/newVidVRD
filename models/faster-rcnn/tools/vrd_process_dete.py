...
base_path = '/home/david/PycharmProjects/newVidVRD/models/rd/dataset/VRD/'

train_file_path = base_path + 'json_dataset/annotations_train.json'
test_file_path = base_path + 'json_dataset/annotations_test.json'
file_path = [train_file_path, test_file_path]
train_image_path = base_path + 'sg_dataset/sg_train_images/'
test_image_path = base_path + '/sg_dataset/sg_test_images/'
