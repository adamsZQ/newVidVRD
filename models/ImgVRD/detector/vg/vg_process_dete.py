...
base_path = '/home/david/PycharmProjects/newVidVRD/models/tf-faster-rcnn/rd/dataset/VG/'

file_path = base_path + 'imdb/vg1_2_meta.h5'
image_path = base_path + 'images/VG_100K/'
