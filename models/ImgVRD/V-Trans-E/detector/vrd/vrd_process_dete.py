...
N_obj = 101
base_path = '/home/david/PycharmProjects/newVidVRD/models/rd/'

train_file_path = base_path + 'dataset/VRD/json_dataset/annotations_train.json'
test_file_path = base_path + 'dataset/VRD/json_dataset/annotations_test.json'
file_path = [train_file_path, test_file_path]
train_image_path = base_path + 'dataset/VRD/sg_dataset/sg_train_images/'
test_image_path = base_path + 'dataset/VRD/sg_dataset/sg_test_images/'
image_path = [train_image_path, test_image_path]
save_path = base_path + 'vtranse/input/vrd_roidb.npz'
