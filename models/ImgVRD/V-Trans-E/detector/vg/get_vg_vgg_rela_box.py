...
base_path = '/home/david/PycharmProjects/newVidVRD/models/tf-faster-rcnn/output/vgg16/vg/'

output_dir = base_path + 'vg_dete_pred/dete_pred_vg.npz'
save_path = base_path + 'vg_dete_pred/vg_detected_box.npz'
model_path = base_path + 'default/res101_faster_rcnn_iter_500000.ckpt'
