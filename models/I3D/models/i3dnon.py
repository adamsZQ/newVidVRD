    ...
    if pretrained:
        ...
        if torch.cuda.is_available():
            pretrained_model = torch.load(
                '/workspace/fyzhang/projects/i3d-nonlocal-affine/kinetics_i3dresnet101__rgb_model_best.pth.tar')
            ...
            pretrained_model = torch.load(
                '/Users/fyzhang/Downloads/vscode/nonlocal/i3d-pytorch/kinetics_i3dresnet101__rgb_model_best.pth.tar')
